...
public class UserHashini implements ActionListener, Runnable {
    ...
    String name = "Hahini Prabuddhika";
    ...
    UserHashini() {
        ...
        JLabel name = new JLabel("F3 Friends");
        name.setBounds(110, 15, 100, 18);
        name.setForeground(Color.WHITE);
        name.setFont(new Font("SAN_SERIF", Font.BOLD, 18));
        p1.add(name);
        
        JLabel status = new JLabel("Chami, Chamindu, Hashini, Radeesha, Amali, Sula");
    ...
    public static void main(String[] args) {
    	UserHashini third = new UserHashini();
